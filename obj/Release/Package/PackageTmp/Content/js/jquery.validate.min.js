...
(function (a) {
    ...
    a.extend(a.validator, {
        ...
        messages: {
            ...
            equalTo: "请再次输入相同的值。",
            maxlength: a.validator.format("最多输入{0}个字。"),
            minlength: a.validator.format("最少输入{0}个字。"),
            rangelength: a.validator.format("请输入{0}到{1}个字符之间的一个值。"),
            range: a.validator.format("请输入{0}到{1}之间的值。"),
            max: a.validator.format("请输入不大于{0}的值。"),
            min: a.validator.format("请输入不小于{0}的值。")
        },
